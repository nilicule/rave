...
from .protocol import AnimationState, PlayerState, Vec3
...
class Player:
    ...
    TODO: add ``last_chat: str | None = None`` when chat lands. The to-wire
    conversion in ``to_state()`` will need a matching field per addition.
    """
